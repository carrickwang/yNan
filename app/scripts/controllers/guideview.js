...
angular.module('luZhouApp')
    .controller('GuideviewCtrl', function(pubSubService,$scope, $interval , $cookieStore, commonService, $loading) {
        // Put cookie
        ...
        */
        // console.log($cookieStore.get('rememberMe'));
        ...
        commonService.getData(ALL_PORT.ArticleList.url, 'POST',
                $.extend({}, ALL_PORT.ArticleList.data, { page: '1', rows: '6', CategoryId: 32 }))
        ...
        //公务员培训新闻
        commonService.getData(ALL_PORT.ArticleList.url, 'POST',
                $.extend({}, ALL_PORT.ArticleList.data, { page: '1', rows: '5', CategoryId: 33 }))
            .then(function(response) {
